function preload() {
  supernomaleRg = loadFont("02_test/fonts/rgFt.ttf");
  supernomaleBd = loadFont("02_test/fonts/bdFt.ttf");
  aktivBd = loadFont("02_test/fonts/AktivGrotesk_KR_Bd.ttf");
  textImg = loadImage("02_test/images/textImg.png");
}
